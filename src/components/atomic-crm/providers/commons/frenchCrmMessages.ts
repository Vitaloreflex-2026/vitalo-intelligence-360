...
export const frenchCrmMessages = {
  resources: {
    ...
    companies: {
      ...
      fields: {
        ...
        nb_trainings_delivered: "Nombre de formations réalisées",
        training_date: "Date de la formation / atelier / conférence",
        quote_approved: "Devis validé",
        service_invoiced: "Prestation facturée",
      },
      list: {
      ...
      nb_deals: "%{smart_count} contrat |||| %{smart_count} contrats",
      no_deals: "Aucun contrat",
      sizes: {
    ...
    deals: {
      ...
      fields: {
        ...
        stage: "Étape",
        sales_id: "Consultant / Formateur",
        trainer_ids: "Intervenant(e)s",
        training_type: "Type de formation",
        nb_trained_managers: "Personnes formées — directeurs / cadres",
        nb_trained_non_managers: "Personnes formées — non cadres",
        nb_trained_total: "Cumul des personnes formées",
        hours_delivered: "Nombre d'heures dispensées",
        qvct_workshop_type: "Type d'atelier QVCT",
        passport_eligible: "Éligible au passeport formation",
        portal_data_sent: "Infos collectées et transmises sur le portail",
        portal_data_sent_at: "Date de transmission au portail",
        qualiopi: "Formation Qualiopi",
        funding_type: "Type de financement",
        quote_signed: "Devis signé",
        quote_signed_at: "Date de signature du devis",
        agreement_signed: "Convention signée",
        agreement_signed_at: "Date de signature de la convention",
        amount_invoiced_incl_tax: "Montant global facturé TTC",
        cost_training: "Frais de formation",
        cost_teaching: "Frais pédagogiques",
        cost_subcontracting: "Frais de sous-traitance",
        cost_travel: "Frais de déplacement",
        cost_materials: "Achat de matériel pédagogique",
        opco_name: "Nom de l'OPCO",
        opco_contact_name: "Nom et prénom de l'interlocuteur OPCO",
        opco_contact_phone: "Ligne directe",
        opco_contact_email: "E-mail",
        opco_file_submitted: "Dépôt du dossier",
        opco_file_submitted_at: "Date de dépôt du dossier",
        appropriation_rate: "Taux d'appropriation Qualiopi (%)",
        satisfaction_rate: "Taux de satisfaction (%)",
      },
      list: {
        error_loading: "Erreur lors du chargement des contrats",
      },
      action: {
        add: "Ajouter un contrat",
        back_to_deal: "Retour au contrat",
        create: "Créer un contrat",
        new: "Nouveau contrat",
      },
      field_categories: {
        misc: "Divers",
        delivery: "Réalisation et facturation",
        training: "Formation",
        funding: "Financement",
        opco: "Détails OPCO",
        invoicing: "Facturation",
        invoicing_breakdown: "Ventilation",
      },
      filters: {
        only_mine: "Seulement les contrats que je gère",
      },
      archived: {
        action: "Archiver",
        error: "Erreur : contrat non archivé",
        list_title: "Contrats archivés",
        success: "Contrat archivé",
        title: "Contrat archivé",
        view: "Afficher les contrats archivés",
      },
      inputs: {
        linked_to: "Lié à",
      },
      unarchived: {
        ...
        error: "Erreur : contrat non désarchivé",
        success: "Contrat désarchivé",
      },
      updated: "Contrat mis à jour",
      empty: {
        before_create: "avant de créer un contrat.",
        description: "Il semble que votre liste de contrats soit vide.",
  ...
  crm: {
    ...
    training_type: {
      ...
      individual_workshop: "Atelier individuel",
      conference: "Conférence",
    },
    qvct_workshop_type: {
      webinar: "Webinaire",
      collective_onsite: "Collectif présentiel",
    ...
    deal_alerts: {
      overdue: "En retard",
      due_on: "à faire pour le %{date}",
      sections: {
        overdue: "Contrats en retard",
        upcoming: "Contrats à compléter",
      },
      kinds: {
        quote_signed: "Devis non signé",
        portal_data_sent: "Infos non transmises sur le portail",
        opco_file: "Dossier OPCO non déposé",
      },
      actions: {
        open: "Ouvrir",
      },
    ...
    activity: {
      ...
      added_note_about_deal: "%{name} a ajouté une note sur le contrat",
      you_added_note_about_deal: "Vous avez ajouté une note sur le contrat",
      added_deal: "%{name} a ajouté le contrat",
      you_added_deal: "Vous avez ajouté le contrat",
      at_company: "chez",
      to: "à",
    ...
    dashboard: {
      ...
      deals_pipeline: "Pipeline des contrats",
    ...
    settings: {
      ...
      deals: {
        ...
        currency: "Devise",
        pipeline_help:
          "Sélectionnez les étapes de contrat à considérer comme des contrats dans le pipeline.",
      ...
      validation: {
        ...
        in_use:
          "Impossible de supprimer %{display_name} encore utilisés par des contrats : %{items}",
