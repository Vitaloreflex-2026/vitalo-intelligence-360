export const englishCrmMessages = {
  resources: {
    ...
    companies: {
      ...
      fields: {
        ...
        nb_trainings_delivered: "Number of trainings delivered",
        training_date: "Training / workshop / conference date",
        quote_approved: "Quote approved",
        service_invoiced: "Service invoiced",
      },
      list: {
      ...
      nb_deals: "%{smart_count} contract |||| %{smart_count} contracts",
      no_deals: "No contract",
      sizes: {
    ...
    deals: {
      ...
      fields: {
        ...
        nb_trained_managers: "People trained — directors / managers",
        nb_trained_non_managers: "People trained — non-managers",
        nb_trained_total: "Total people trained",
        hours_delivered: "Hours delivered",
        qvct_workshop_type: "QVCT workshop type",
        passport_eligible: "Eligible for the training passport",
        portal_data_sent: "Data collected and filed on the portal",
        portal_data_sent_at: "Portal filing date",
        qualiopi: "Qualiopi training",
        funding_type: "Funding type",
        quote_signed: "Quote signed",
        quote_signed_at: "Quote signature date",
        agreement_signed: "Agreement signed",
        agreement_signed_at: "Agreement signature date",
        amount_invoiced_incl_tax: "Total invoiced (incl. tax)",
        cost_training: "Training costs",
        cost_teaching: "Teaching costs",
        cost_subcontracting: "Subcontracting costs",
        cost_travel: "Travel costs",
        cost_materials: "Teaching material purchases",
        opco_name: "OPCO name",
        opco_contact_name: "OPCO contact name",
        opco_contact_phone: "Direct line",
        opco_contact_email: "Email",
        opco_file_submitted: "File submitted",
        opco_file_submitted_at: "File submission date",
        appropriation_rate: "Qualiopi appropriation rate (%)",
      ...
      action: {
        add: "Add contract",
        back_to_deal: "Back to contract",
        create: "Create contract",
        new: "New Contract",
      },
      field_categories: {
        misc: "Misc",
        delivery: "Delivery and invoicing",
        training: "Training",
        funding: "Funding",
        opco: "OPCO details",
        invoicing: "Invoicing",
        invoicing_breakdown: "Breakdown",
      },
      filters: {
        only_mine: "Only contracts I manage",
      },
      archived: {
        action: "Archive",
        error: "Error: contract not archived",
        list_title: "Archived Contracts",
        success: "Contract archived",
        title: "Archived Contract",
        view: "View archived contracts",
      },
      inputs: {
        linked_to: "Linked to",
      },
      unarchived: {
        ...
        error: "Error: contract not unarchived",
        success: "Contract unarchived",
      },
      updated: "Contract updated",
      empty: {
        before_create: "before creating a contract.",
        description: "It seems your contract list is empty.",
  ...
  crm: {
    ...
    training_type: {
      ...
      individual_workshop: "Individual workshop",
      conference: "Conference",
    },
    qvct_workshop_type: {
      webinar: "Webinar",
      collective_onsite: "Collective, on site",
    ...
    deal_alerts: {
      ...
      due_on: "due on %{date}",
      sections: {
        overdue: "Overdue contracts",
        upcoming: "Contracts to complete",
      },
      kinds: {
        quote_signed: "Quote not signed",
        portal_data_sent: "Data not filed on the portal",
        opco_file: "OPCO file not submitted",
      },
      actions: {
        open: "Open",
      },
    ...
    activity: {
      ...
      added_note_about_deal: "%{name} added a note about contract",
      you_added_note_about_deal: "You added a note about contract",
      added_deal: "%{name} added contract",
      you_added_deal: "You added contract",
      at_company: "at",
      to: "to",
    ...
    dashboard: {
      ...
      deals_pipeline: "Contracts Pipeline",
    ...
    settings: {
      ...
      deals: {
        ...
        currency: "Currency",
        pipeline_help:
          "Select which contract stages should count as pipeline contracts.",
      ...
      validation: {
        ...
        in_use:
          "Cannot remove %{display_name} that are still used by contracts: %{items}",
